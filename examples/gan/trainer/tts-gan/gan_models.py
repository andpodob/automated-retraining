...
class Generator(nn.Module):
    def __init__(self, seq_len=SEQ_LEN, patch_size=PATCH_SIZE, channels=CHANNELS, latent_dim=100, embed_dim=EMBED_DIM, depth=DEPTH,
                 num_heads=NUM_HEADS, forward_drop_rate=0.5, attn_drop_rate=0.5):
